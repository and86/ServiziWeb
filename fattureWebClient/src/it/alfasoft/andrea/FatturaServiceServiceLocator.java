...
public class FatturaServiceServiceLocator extends org.apache.axis.client.Service implements it.alfasoft.andrea.FatturaServiceService {
    ...
    private java.lang.String FatturaService_address = "http://localhost:1234/EsempioFattureWeb/services/FatturaService";
    ...
    public it.alfasoft.andrea.FatturaService getFatturaService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            it.alfasoft.andrea.FatturaServiceSoapBindingStub _stub = new it.alfasoft.andrea.FatturaServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (it.alfasoft.andrea.FatturaService.class.isAssignableFrom(serviceEndpointInterface)) {
                it.alfasoft.andrea.FatturaServiceSoapBindingStub _stub = new it.alfasoft.andrea.FatturaServiceSoapBindingStub(new java.net.URL(FatturaService_address), this);
                _stub.setPortName(getFatturaServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://andrea.alfasoft.it", "FatturaServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://andrea.alfasoft.it", "FatturaService"));
        }
